...
const (
	...
	FrameType_STREAM_START FrameType = 1
	FrameType_STREAM_DATA  FrameType = 2
	FrameType_STREAM_END   FrameType = 3
	FrameType_HEARTBEAT    FrameType = 4
)
...
const file_rpc_proto_rpc_proto_rawDesc = "" +
	...
	"\tFrameType\x12\t\n" +
	"\x05UNARY\x10\x00\x12\x10\n" +
	"\fSTREAM_START\x10\x01\x12\x0f\n" +
	"\vSTREAM_DATA\x10\x02\x12\x0e\n" +
	"\n" +
	"STREAM_END\x10\x03\x12\r\n" +
	"\tHEARTBEAT\x10\x04B#Z!github.com/jsndz/bottle/rpc/protob\x06proto3"
